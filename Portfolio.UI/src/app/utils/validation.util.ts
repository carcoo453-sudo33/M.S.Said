...
/**
 * Validation utility functions for forms, URLs, emails, and content sanitization
...
export class ValidationUtil {
     ...
     * @returns Validation result with sanitized content and error messages
     */
    static validateComment(content: string): { isValid: boolean; sanitized: string; errors: string[] } {
        const errors: string[] = [];
     ...
     * @param form Contact form object to validate
     * @returns Validation result with error messages
     */
    static validateContactForm(form: any): { isValid: boolean; errors: string[] } {
        const errors: string[] = [];
