...
@Component({
    ...
    <header class="pt-32 mb-16 text-center animate-fade-in-up">
        <h1
            ...
            <span>Selected <span
                    class="text-red-600 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-2 after:bg-red-600/10 tracking-widest leading-none">Works</span></span>
        </h1>
        <p
            ...
            Full Stack Engineering • Architectural Design • High-Performance Systems
        </p>
