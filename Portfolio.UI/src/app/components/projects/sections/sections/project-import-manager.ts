...
@Component({
    ...
    template: `
        ...
        <div class="space-y-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <h3 class="text-lg font-semibold text-blue-800">Import from GitHub/URL</h3>
            ...
            <div class="flex gap-2">
                ...
                <button 
                    ...
                    class="px-4 py-2 bg-blue-600 text-white rounded-lg disabled:opacity-50 flex items-center gap-2 hover:bg-blue-700 transition-colors"
                >
