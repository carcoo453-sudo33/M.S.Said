    ...
    <ng-container *ngIf="project">
        ...
        <section class="space-y-10 animate-fade-in-up" style="animation-delay: 0.2s">
            <div class="relative group rounded-[3rem] overflow-hidden border border-zinc-900 bg-zinc-950 aspect-video shadow-2xl">
                <img [src]="project.imageUrl" class="w-full h-full object-cover grayscale opacity-60 group-hover:opacity-100 group-hover:grayscale-0 transition-all duration-1000 group-hover:scale-105">
            ...
            <!-- Gallery Thumbnails -->
            <div class="flex gap-6 overflow-x-auto pb-4 no-scrollbar" *ngIf="project.gallery && project.gallery.length > 0">
