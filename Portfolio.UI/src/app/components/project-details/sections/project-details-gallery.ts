            ...
            <div class="relative group rounded-xl overflow-hidden border border-zinc-900 bg-zinc-950 aspect-video shadow-2xl cursor-pointer"
                ...
                <div class="absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20">
                    <a [href]="project.projectUrl" target="_blank" *ngIf="project.projectUrl"
                        ...
                        class="bg-red-600 text-white px-6 lg:px-8 py-3 lg:py-4 rounded-xl font-black text-sm uppercase tracking-widest flex items-center gap-2 lg:gap-3 hover:bg-red-700 hover:scale-110 transition-all shadow-2xl shadow-red-600/40">
                    ...
                    <a [href]="project.gitHubUrl" target="_blank" *ngIf="project.gitHubUrl"
                        (click)="$event.stopPropagation()"
                        class="bg-black/80 backdrop-blur-md border-2 border-white/30 text-white px-6 lg:px-8 py-3 lg:py-4 rounded-xl font-black text-sm uppercase tracking-widest flex items-center gap-2 lg:gap-3 hover:border-red-600 hover:bg-red-600 hover:scale-110 transition-all shadow-2xl">
                ...
                <div class="absolute ltr:right-4 ltr:lg:right-6 rtl:left-4 rtl:lg:left-6 top-1/2 -translate-y-1/2 flex flex-col gap-3 lg:gap-4 z-20">
                    ...
                    <button (click)="onReact(); $event.stopPropagation()"
                        ...
                        <span class="text-[10px] font-black text-white">{{ project.reactionsCount || 0 }}</span>
                    </button>
                    ...
                    <button (click)="onShare(); $event.stopPropagation()"
                        ...
                        <span class="text-[10px] font-black text-white uppercase tracking-wider">Share</span>
                    </button>
                    ...
                    <div class="flex flex-col items-center gap-1.5 bg-black/80 backdrop-blur-md px-3 lg:px-4 py-3 lg:py-4 rounded-xl border border-white/10">
                        ...
                        <span class="text-[10px] font-black text-white">{{ project.views || 0 }}</span>
                    </div>
                    
                    <!-- Comments Counter -->
                    <div class="flex flex-col items-center gap-1.5 bg-black/80 backdrop-blur-md px-3 lg:px-4 py-3 lg:py-4 rounded-xl border border-white/10">
                        <lucide-icon [img]="MessageCircleIcon" class="w-4 h-4 lg:w-5 lg:h-5 text-green-500"></lucide-icon>
                        <span class="text-[10px] font-black text-white">{{ project.comments?.length || 0 }}</span>
                    </div>
                </div>
