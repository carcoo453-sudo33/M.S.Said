...
@Component({
  ...
  template: `
    <div class="relative">
      ...
      <!-- Dropdown Menu -->
      <div *ngIf="isOpen()"
        class="absolute mt-2 w-96 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden z-50 animate-notification-fade-in-up ltr:right-0 rtl:left-0">
        ...
        <div class="max-h-96 overflow-y-auto notification-scrollbar">
          ...
          <div *ngFor="let notification of notificationService.notifications()"
            ...
            class="p-4 border-b border-zinc-100 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-all group cursor-pointer"
    ...
    <div *ngIf="selectedMessage()"
      ...
      <!-- Modal Backdrop -->
      <div (click)="closeMessageModal()"
        class="absolute inset-0 bg-black/60 backdrop-blur-sm"></div>
      
      <!-- Modal Content -->
      <div class="relative bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 max-w-2xl w-full max-h-[90vh] overflow-hidden animate-scale-in">
        <!-- Header -->
        <div class="p-6 border-b border-zinc-200 dark:border-zinc-800 bg-gradient-to-r from-red-600 to-red-700">
        ...
        <div class="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
          <!-- Sender Info -->
          <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-xl p-6 border border-zinc-200 dark:border-zinc-800 mb-6">
        ...
        <!-- Footer -->
        <div class="p-6 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex items-center justify-between gap-4">
          <button
            (click)="closeMessageModal()"
