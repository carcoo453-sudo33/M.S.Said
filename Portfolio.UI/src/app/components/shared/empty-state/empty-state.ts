...
@Component({
    ...
    template: `
    <section class="text-center py-12 animate-fade-in-up">
        <div
            class="bg-zinc-50/50 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800 rounded-xl p-12 max-w-2xl mx-auto space-y-10">
            <div
