            ...
            <div *ngFor="let item of education; let i = index"
                ...
                <div
                    ...
                    <h3 class="text-base font-black mb-2 uppercase tracking-tight leading-tight dark:text-white text-zinc-900">
                        {{ item.degree }}</h3>
                    <p class="text-[10px] font-bold uppercase tracking-wide text-zinc-400 mb-3">{{ item.institution }}</p>
                    <p class="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed mb-3">"{{ item.description }}"</p>
                    <div class="flex items-center gap-2 text-zinc-400 transition-colors"
                        ...
                        <span class="text-[10px] uppercase tracking-wide font-bold">{{ item.location }}</span>
                    </div>
                </div>
            </div>
        </div>
