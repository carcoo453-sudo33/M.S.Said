...
public static class EducationMapper
{
    ...
    public static EducationDto ToDto(EducationEntity entity)
    {
        ...
        {
            Id = entity.Id,
            Institution = entity.Institution ?? string.Empty,
            Institution_Ar = entity.Institution_Ar ?? string.Empty,
            Degree = entity.Degree ?? string.Empty,
            Degree_Ar = entity.Degree_Ar ?? string.Empty,
            ...
            Location_Ar = entity.Location_Ar ?? string.Empty,
