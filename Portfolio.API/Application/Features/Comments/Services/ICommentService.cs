...
Task<CommentDto> AddCommentAsync(Guid projectId, CommentCreateDto request, CancellationToken cancellationToken = default);
    /// <summary>
...
Task<CommentDto> AddReplyAsync(Guid projectId, Guid commentId, CommentCreateDto request, CancellationToken cancellationToken = default);
    /// <summary>
...
Task<int> LikeCommentAsync(Guid projectId, Guid commentId, CancellationToken cancellationToken = default);
}
